...
class MyCustomATTEventHandler(ATTEventHook):
    ...
    def att_write_hook(self, gatt_handle, data):
        ...
        #print("ATT write hook triggered. Write value to attribute: %s value: %s" % (hex(gatt_handle), data))
        if data=="superpass":
            print "__   __               _                  _           _      _                         "
            print "\ \ / /              | |                | |         | |    | |                        "
            print " \ V /___  _   _     | |_ _ __ _   _ ___| |_ ___  __| |    | |_ ___        __ _  ___  "
            print "  \ // _ \| | | |    | __| '__| | | / __| __/ _ \/ _` |    | __/ _ \      / _` |/ _ \ "
            print "  | | (_) | |_| |    | |_| |  | |_| \__ \ ||  __/ (_| |    | || (_) |    | (_| | (_) |"
            print "  \_/\___/ \__,_|     \__|_|   \__,_|___/\__\___|\__,_|     \__\___/      \__, |\___/ "
            print "                                                                           __/ |      "
            print "                                                                          |___/       "
        else:
            print " _    _                                                                       _ _ "
            print "| |  | |                                                                     | | |"
            print "| |  | |_ __ ___  _ __   __ _       _ __   __ _ ___ _____      _____  _ __ __| | |"
            print "| |/\| | '__/ _ \| '_ \ / _` |     | '_ \ / _` / __/ __\ \ /\ / / _ \| '__/ _` | |"
            print "\  /\  / | | (_) | | | | (_| |     | |_) | (_| \__ \__ \\ V  V / (_) | | | (_| |_|"
            print " \/  \/|_|  \___/|_| |_|\__, |     | .__/ \__,_|___/___/ \_/\_/ \___/|_|  \__,_(_)"
            print "                         __/ |     | |                                            "
            print "                        |___/      |_|                                            "
